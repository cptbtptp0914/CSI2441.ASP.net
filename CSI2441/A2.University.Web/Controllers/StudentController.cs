...
namespace A2.University.Web.Controllers
{
    public class StudentController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "student_id,firstname,lastname,dob,gender,email,ph_landline,ph_mobile,adrs,adrs_city,adrs_state,adrs_postcode")] StudentEditViewModel studentViewModel)
        {
            if (ModelState.IsValid)
            {
                // generate new email
